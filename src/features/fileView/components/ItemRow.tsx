import Preview from "@/features/fileView/components/Preview.tsx";
import { ModalContext } from "@/context/useContext.tsx";
...
function ItemRow({ item, onclick, isSelected }: ItemRowProps) {
    const { openModal, isOpen, closeModal } = ModalContext();
