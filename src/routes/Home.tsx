    ...
    return (
        <>
            <header className="flex border px-8 py-4 items-center">
                ...
                <div className="mx-auto border-black/40 border rounded-sm  flex items-center gap-x-4 cursor-pointer relative w-2/3">
                    <input
                    ...
                    />
                    <div
                        className={`top-full left-0 border-black/40 border border-t-0 bg-white absolute ${
                    ...
                    >
                        {foundItems.length > 0 ? (
                            ...
                            <span className="text-black/40 text-sm p-2">
